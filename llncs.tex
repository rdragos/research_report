...
\centerline{\huge \bf Aplica\c{t}ii ale Schemelor de Partajare a Secretelor}
\vspace{0.35cm}
...
\centerline{\Large \bf - Sisteme de Stocare de Lung\u{a} Durat\u{a}}
\vspace{0.35cm}
\centerline{\Large \bf bazate pe Scheme de Partajare a Secretelor -}
...
Lucrarea de fa\c{t}\u{a} analizeaz\u{a} sistemele de stocare de lung\u{a} durat\u{a} bazate pe scheme de partajare a secretelor.
Cum volumul de datelor electronice este \^{i}n continu\u{a} cre\c{s}tere, necesitatea stoc\u{a}rii sigure a devenit extrem de necesar\u{a}. Date sensibile trebuie men\c{t}inute secrete, c\^{a}teodat\u{a} pentru lungi perioade de timp (zeci de ani). Exemple includ informa\c{t}ii militare, documete legale sau dosare medicale: informa\c{t}iile militare pot fi clasificate zeci de ani, un testament trebuie men\c{t}inut secret p\^{a}n\u{a} la deschiderea sa oficial\u{a},  un dosar medical necesit\u{a} p\u{a}strare sigur\u{a} (cel pu\c{t}in) pe toat\u{a} durata vie\c{t}ii pacientului.
...
\begin{itemize}
	...
	\item Sec\c{t}iunea {\ref{sec:long_term_systems_intro}} con\c{t}ine cerin\c{t}ele pe care trebuie s\u{a} le \^{i}ndeplineasc\u{a} un sistem de stocare de lunga durat\u{a} \c{s}i compar\u{a} sistemele de criptare de lung\u{a} durat\u{a} care utilizeaz\u{a} criptarea cu sistemele de stocare bazate pe scheme de partajare a secretelor.
	...
	\item Sec\c{t}iunea {\ref{sec:obtained_results}} con\c{t}ine contribu\c{t}iile de cercetare, pun\^{a}nd \^{i}n eviden\c{t}\u{a} problemele cauzate de determinismul sistemului introdus \^{i}n Sec\c{t}iunea {\ref{sec:desc_alouneh}}.
\end{itemize}
...
Pe baza rezultatelor ob\c{t}inute am redactat (\^{i}mpreun\u{a} cu mentorul) un articol, aflat momentan \^{i}n procesul de recenzie la Journal of Control Engineering and Applied Informatics (jurnal indexat ISI,categoria C). \cite{Ceai_art:2015,Ceai:2015}
%
% ---- Bibliography ----
%
