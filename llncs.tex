...
\subsubsection{Schema lui Shamir}
%TODO complete description

\subsubsection{Schema Ito, Saito, si Nishizeki}
\label{Ito}
...
In 2007 este propus un nou sistem care combina caracteristicile PASIS si GridSharing adaugand posiblitatea de a realiza migrarea datelor la noduri noi.
