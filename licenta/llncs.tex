...
%\centerline{\bf UNIVERSITY OF BUCHAREST}
...
\centerline{\huge \bf Lucrare de licen\c{t}\u{a}}
\vspace{0.35cm}
%\centerline{\huge \bf - Sisteme de stocare de lung\u{a} durat\u{a}}
%\vspace{0.35cm}


\vspace{3cm}

\centerline{\Large \bf - Protocoale Criptografice de Grup - }
\vspace{0.35cm}

\vspace{4.5cm}

\begin{flushleft}
{\Large \textit{Profesor \^{i}ndrum\u{a}tor:}\vspace{0.2cm}}
...
Un rol important \^{i}n criptografia actual\u{a} \^{i}l de\c{t}ine criptografia de grup, care permite definirea \c{s}i analiza securit\u{a}\c{t}ii unor protocoale la care iau parte mai mult de 2 participan\c{t}i.

\^{I}n cadrul criptografiei exist\u{a} multiple primitive care stau la baza tutoror protocoalelor precum: semn\u{a}turi digitale, func\c{t}ii one-way (hash), scheme de partajare, schmbul sigur de chei.
...
O schem\u{a} de partajare reprezint\u{a} o metod\u{a} de a distribui un secret unor participan\c{t}i, oferind fiec\u{a}rui participant o component\u{a} (share) astfel \^{i}nc\^{a}t doar o submul\c{t}ime de participan\c{t}i pot recupera secretul.

\subsection{Motiva\c{t}ie}

Lucrarea de fa\c{t}\u{a} analizeaz\u{a} c\^{a}teva dintre primitivele criptografice prezentand aplicatii construite pe baza lor, finalizand cu prezentarea unei arhitecturi implementate cu ajutorul schemelor de partajare.

vulnerabilitati sistemele de stocare de lung\u{a} durat\u{a} bazate pe scheme de partajare a secretelor.
...
P\u{a}strarea confiden\c{t}ialit\u{a}\c{t}ii \c{s}i redundan\c{t}i datelor pe perioade lungi de timp reprezint\u{a} o sarcin\u{a} dificil\u{a} din cauza multiplelor probleme care pot ap\u{a}rea precum atacuri, erori umane, defec\c{t}iunea unor componente hardware sau dezastre naturale \cite{BSRR:2006,SGM:2006}.
...
\section{Func\c{t}ii pseudoaleatoare}
\label{sec:prf}

\subsection{Defini\c{t}ii de securitate}
\label{subsec:prf-security}

\subsection{Func\c{t}ii pseudoaleatoare constr\^{a}nse}
\label{subsec:cprf}

\section{ID-NIKE}
\label{sec:id-nike}

\subsection{Construc\c{t}ia Boneh Waters}
...
\subsection{Contribu\c{t}ii}
\label{subsec:multi-party-contributions}
...
\section{Implement\u{a}ri alternative}
\label{sec:alternave-implementations}

\subsection{Arhitectur\u{a} bazat\u{a} pe scheme de partajare}

\subsection{Servere Amazon}

\subsection{Reconstruirea fi\c{s}ierelor}
